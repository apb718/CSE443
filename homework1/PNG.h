...
public:
	...
	*/
    ...
    /**
     * Draws a red box at coordinates with width and height
     * 
     * \param[in] png The png of the image to draw the red boxes in.
     * 
     * \param[in] row The row of the initial coordinate to start drawing the box that will be colored red
     * 
     * \param[in] col The col of the inital coordinate to start drawing the box that will be colored red
     * 
     * \param[in] width The width of the box that will be colored red
     * 
     * \param[in] height The height of the box that will be colored red
     * 
    */
