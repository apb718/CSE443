...
// Make employee be consistent with primitive types like int, long, etc.
// We need at least 3 operators
//  1. Read employee objects
//  2. Write employee objects
//  3. Compare employee objects
