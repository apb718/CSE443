...
int useIf(const int i) {
    // Implement this method to use a series of if-else statements to
    // accomplish the same functionality as the useSwitch method
    // below.
    if (i == 0) {
        return 1;
    } else if (i == 1) {
...
int main(int argc, char *argv[]) {
    const int NumIter = (argc > 2 ? std::stoi(argv[2]) : 1000000000);
    int sum = 0;
